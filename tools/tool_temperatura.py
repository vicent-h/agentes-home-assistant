...
def obter_clima_da_casa() -> dict:
    ...
    try:
        ...
        temperatura_confortavel = ha.get_entity_state("input_number.temperatura_para_abrir_as_portas_e_persianas")['state']
        return {
            "temperatura": temperatura,
            "velocidade_vento": velocidade_vento,
            "temperatura_confortavel": temperatura_confortavel
        }
